...
#import "CMBasicAuthTokenProvider.h"
#import "CMLogger.h"

@interface CMDefaultConfiguration ()
...
@implementation CMDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static CMDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    self = [super init];
    if (self) {
        _host = @"https://api.cloudmersive.com";
        _username = @"";
        _password = @"";
        _accessToken= @"";
        _verifySSL = YES;
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [CMBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];

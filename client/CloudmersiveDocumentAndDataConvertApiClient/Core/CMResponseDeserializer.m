...
NSString *const CMDeserializationErrorDomainKey = @"CMDeserializationErrorDomainKey";

NSInteger const CMTypeMismatchErrorCode = 143553;

NSInteger const CMEmptyValueOccurredErrorCode = 143509;

NSInteger const CMUnknownResponseObjectErrorCode = 143528;


@interface CMResponseDeserializer ()
...
@implementation CMResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:CMDeserializationErrorDomainKey code:CMTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:CMDeserializationErrorDomainKey code:CMEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:CMDeserializationErrorDomainKey code:CMUnknownResponseObjectErrorCode userInfo:userInfo];
}

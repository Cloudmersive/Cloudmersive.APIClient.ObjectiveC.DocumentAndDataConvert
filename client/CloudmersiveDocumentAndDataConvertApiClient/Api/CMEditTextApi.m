...
@interface CMEditTextApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CMEditTextApi

NSString* kCMEditTextApiErrorDomain = @"CMEditTextApiErrorDomain";
NSInteger kCMEditTextApiMissingParamErrorCode = 234513;
...
///
///  @returns CMBase64DecodeResponse*
///
-(NSURLSessionTask*) editTextBase64DecodeWithRequest: (CMBase64DecodeRequest*) request
    ...
    if (request == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCMEditTextApiErrorDomain code:kCMEditTextApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/encoding/base64/decode"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"CMBase64DecodeResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMBase64DecodeResponse*)data, error);
                                }
                            }];
}
...
///  @param request Input request 
///
///  @returns CMBase64DetectResponse*
///
-(NSURLSessionTask*) editTextBase64DetectWithRequest: (CMBase64DetectRequest*) request
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/encoding/base64/detect"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMBase64DetectResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMBase64DetectResponse*)data, error);
                                }
                            }];
}
...
///  @param request Input request 
///
///  @returns CMBase64EncodeResponse*
///
-(NSURLSessionTask*) editTextBase64EncodeWithRequest: (CMBase64EncodeRequest*) request
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/encoding/base64/encode"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMBase64EncodeResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMBase64EncodeResponse*)data, error);
                                }
                            }];
}
...
///
///  @returns CMChangeLineEndingResponse*
///
-(NSURLSessionTask*) editTextChangeLineEndingsWithLineEndingType: (NSString*) lineEndingType
    ...
    if (lineEndingType == nil) {
        NSParameterAssert(lineEndingType);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"lineEndingType"] };
            NSError* error = [NSError errorWithDomain:kCMEditTextApiErrorDomain code:kCMEditTextApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/line-endings/change"];
    ...
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    if (lineEndingType != nil) {
        headerParams[@"lineEndingType"] = lineEndingType;
    }
    // HTTP header `Accept`
    NSString *acceptHeader = [self.apiClient.sanitizer selectHeaderAccept:@[@"application/json", @"text/json", @"application/xml", @"text/xml"]];
    if(acceptHeader.length > 0) {
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMChangeLineEndingResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMChangeLineEndingResponse*)data, error);
                                }
                            }];
}
...
///  @param inputFile Input file to perform the operation on. 
///
///  @returns CMDetectLineEndingsResponse*
///
-(NSURLSessionTask*) editTextDetectLineEndingsWithInputFile: (NSURL*) inputFile
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/line-endings/detect"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMDetectLineEndingsResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMDetectLineEndingsResponse*)data, error);
                                }
                            }];
}
...
///  @param request Input request 
///
///  @returns CMFindStringRegexResponse*
///
-(NSURLSessionTask*) editTextFindRegexWithRequest: (CMFindStringRegexRequest*) request
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/find/regex"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMFindStringRegexResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMFindStringRegexResponse*)data, error);
                                }
                            }];
}
...
///  @param request Input request 
///
///  @returns CMFindStringSimpleResponse*
///
-(NSURLSessionTask*) editTextFindSimpleWithRequest: (CMFindStringSimpleRequest*) request
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/find/string"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMFindStringSimpleResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMFindStringSimpleResponse*)data, error);
                                }
                            }];
}
...
///  @param request Input request 
///
///  @returns CMRemoveWhitespaceFromTextResponse*
///
-(NSURLSessionTask*) editTextRemoveAllWhitespaceWithRequest: (CMRemoveWhitespaceFromTextRequest*) request
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/remove/whitespace/all"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMRemoveWhitespaceFromTextResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMRemoveWhitespaceFromTextResponse*)data, error);
                                }
                            }];
}
...
///  @param request Input request 
///
///  @returns CMRemoveHtmlFromTextResponse*
///
-(NSURLSessionTask*) editTextRemoveHtmlWithRequest: (CMRemoveHtmlFromTextRequest*) request
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/remove/html"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMRemoveHtmlFromTextResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMRemoveHtmlFromTextResponse*)data, error);
                                }
                            }];
}
...
///  @param request Input request 
///
///  @returns CMReplaceStringRegexResponse*
///
-(NSURLSessionTask*) editTextReplaceRegexWithRequest: (CMReplaceStringRegexRequest*) request
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/replace/regex"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMReplaceStringRegexResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMReplaceStringRegexResponse*)data, error);
                                }
                            }];
}
...
///  @param request Input request 
///
///  @returns CMReplaceStringSimpleResponse*
///
-(NSURLSessionTask*) editTextReplaceSimpleWithRequest: (CMReplaceStringSimpleRequest*) request
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/replace/string"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMReplaceStringSimpleResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMReplaceStringSimpleResponse*)data, error);
                                }
                            }];
}
...
///  @param inputFile Input file to perform the operation on. 
///
///  @returns CMTextEncodingDetectResponse*
///
-(NSURLSessionTask*) editTextTextEncodingDetectWithInputFile: (NSURL*) inputFile
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/encoding/detect"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMTextEncodingDetectResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMTextEncodingDetectResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) editTextTrimWhitespaceWithRequest: (CMRemoveWhitespaceFromTextRequest*) request
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/convert/edit/text/remove/whitespace/trim"];

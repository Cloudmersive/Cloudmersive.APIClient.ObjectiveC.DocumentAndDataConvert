...
@protocol CMGetDocxTableByIndexRequest
@end

@interface CMGetDocxTableByIndexRequest : CMObject
...
/* 0-based index of the table to retrieve from the Word Document [optional]
 */

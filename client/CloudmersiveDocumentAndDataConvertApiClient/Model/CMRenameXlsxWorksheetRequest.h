...
@protocol CMRenameXlsxWorksheetRequest
@end

@interface CMRenameXlsxWorksheetRequest : CMObject
 ...
 */
@property(nonatomic) CMXlsxWorksheet* worksheetToRename;
/* Required; The new name to be used for the worksheet [optional]
 */
@property(nonatomic) NSString* varNewWorksheetName;

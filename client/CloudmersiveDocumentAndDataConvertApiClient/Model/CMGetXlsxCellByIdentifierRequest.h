...
@protocol CMGetXlsxCellByIdentifierRequest
@end

@interface CMGetXlsxCellByIdentifierRequest : CMObject
...
/* Required; Excel cell identifier, e.g. A1, B22, C33, etc. [optional]
 */

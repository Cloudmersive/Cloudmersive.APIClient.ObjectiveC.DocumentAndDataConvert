...
@protocol CMGetXlsxColumnsRequest
@end

@interface CMGetXlsxColumnsRequest : CMObject
...
/* Optional; Worksheet (tab) within the spreadsheet to get the columns of; leave blank to default to the first worksheet [optional]
 */

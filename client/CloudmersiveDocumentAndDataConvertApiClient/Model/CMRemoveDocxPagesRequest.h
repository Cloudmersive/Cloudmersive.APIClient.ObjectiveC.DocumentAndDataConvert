...
@protocol CMRemoveDocxPagesRequest
@end

@interface CMRemoveDocxPagesRequest : CMObject
...
/* Page number (1-based) to start deleting pages; inclusive [optional]
 */
@property(nonatomic) NSNumber* startDeletePageNumber;
/* Page number (1-based) to stop deleting pages; inclusive [optional]
 */
@property(nonatomic) NSNumber* endDeletePageNumber;

...
@protocol CMClearXlsxRowRequest
@end

@interface CMClearXlsxRowRequest : CMObject
 ...
 */
@property(nonatomic) CMXlsxWorksheet* worksheetToEdit;
/* Required; Index for the desired row to be cleared [optional]
 */

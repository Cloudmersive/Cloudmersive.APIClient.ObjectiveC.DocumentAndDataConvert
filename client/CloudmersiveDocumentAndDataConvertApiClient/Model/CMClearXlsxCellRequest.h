...
@protocol CMClearXlsxCellRequest
@end

@interface CMClearXlsxCellRequest : CMObject
...
/* 0-based index of the row, 0, 1, 2, ... to clear [optional]
 */
@property(nonatomic) NSNumber* rowIndex;
/* 0-based index of the cell, 0, 1, 2, ... in the row to clear [optional]
 */

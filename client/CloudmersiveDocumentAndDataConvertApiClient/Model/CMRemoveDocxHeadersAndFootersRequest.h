...
@protocol CMRemoveDocxHeadersAndFootersRequest
@end

@interface CMRemoveDocxHeadersAndFootersRequest : CMObject
...
/* True if you would like to remove all headers from the input document, false otherwise [optional]
 */
@property(nonatomic) NSNumber* removeHeaders;
/* True if you would like to remove all footers from the input document, false otherwise [optional]
 */
@property(nonatomic) NSNumber* removeFooters;

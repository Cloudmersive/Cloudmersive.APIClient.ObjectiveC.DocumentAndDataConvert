...
@protocol CMGetDocxTableRowRequest
@end

@interface CMGetDocxTableRowRequest : CMObject
...
/* Path to the table to retrievew the row from [optional]
 */
@property(nonatomic) NSString* tablePath;
/* 0-based index of the row to retrieve (e.g. 0, 1, 2, ...) in the table [optional]
 */

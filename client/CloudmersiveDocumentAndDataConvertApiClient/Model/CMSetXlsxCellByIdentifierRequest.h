...
@protocol CMSetXlsxCellByIdentifierRequest
@end

@interface CMSetXlsxCellByIdentifierRequest : CMObject
...
/* The Excel cell identifier (e.g. A1, B2, C33, etc.) of the cell to update [optional]
 */

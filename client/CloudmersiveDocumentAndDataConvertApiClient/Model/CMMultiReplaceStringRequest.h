...
@class CMSingleReplaceString;



@protocol CMMultiReplaceStringRequest
@end

@interface CMMultiReplaceStringRequest : CMObject
...
/* An array of individual string replacement requests [optional]
 */
@property(nonatomic) NSArray<CMSingleReplaceString>* replaceStrings;

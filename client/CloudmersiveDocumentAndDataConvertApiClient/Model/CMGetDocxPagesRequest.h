...
@protocol CMGetDocxPagesRequest
@end

@interface CMGetDocxPagesRequest : CMObject
...
/* Optional: Maximum number of pages to return; set to 0 or do not supply to return all pages [optional]
 */
@property(nonatomic) NSNumber* maximumPages;

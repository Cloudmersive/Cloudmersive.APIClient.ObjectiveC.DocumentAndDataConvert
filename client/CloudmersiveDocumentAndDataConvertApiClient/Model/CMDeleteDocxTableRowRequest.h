...
@protocol CMDeleteDocxTableRowRequest
@end

@interface CMDeleteDocxTableRowRequest : CMObject
...
/* 0-based index of the row to delete (e.g. 0, 1, 2, ...) in the table [optional]
 */
@property(nonatomic) NSNumber* tableRowRowIndex;

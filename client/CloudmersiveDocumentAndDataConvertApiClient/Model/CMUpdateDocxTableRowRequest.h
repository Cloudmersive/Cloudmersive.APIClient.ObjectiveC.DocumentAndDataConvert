...
@protocol CMUpdateDocxTableRowRequest
@end

@interface CMUpdateDocxTableRowRequest : CMObject
...
/* Table row contents you would like to update the row with [optional]
 */
@property(nonatomic) CMDocxTableRow* rowToUpdate;

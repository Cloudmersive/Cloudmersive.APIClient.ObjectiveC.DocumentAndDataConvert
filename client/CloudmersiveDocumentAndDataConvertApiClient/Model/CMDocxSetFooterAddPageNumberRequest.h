...
@protocol CMDocxSetFooterAddPageNumberRequest
@end

@interface CMDocxSetFooterAddPageNumberRequest : CMObject
...
/* Optional: extra text to add before the page number, for example if you want to show \"Page 1\" then you can set PrependText to \"Page\" [optional]
 */
@property(nonatomic) NSString* prependText;

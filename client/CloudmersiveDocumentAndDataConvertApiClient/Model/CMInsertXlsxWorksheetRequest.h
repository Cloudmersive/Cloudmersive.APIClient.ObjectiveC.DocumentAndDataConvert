...
@protocol CMInsertXlsxWorksheetRequest
@end

@interface CMInsertXlsxWorksheetRequest : CMObject
...
/* Workersheet to insert [optional]
 */
@property(nonatomic) CMXlsxWorksheet* worksheetToInsert;

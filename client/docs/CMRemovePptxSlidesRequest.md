...
**startDeleteSlideNumber** | **NSNumber*** | Slide number (1-based) to start deleting slides; inclusive | [optional] 
**endDeleteSlideNumber** | **NSNumber*** | Slide number (1-based) to stop deleting slides; inclusive | [optional] 

# CMDocxSetFooterAddPageNumberRequest
...
**prependText** | **NSString*** | Optional: extra text to add before the page number, for example if you want to show \&quot;Page 1\&quot; then you can set PrependText to \&quot;Page\&quot; | [optional] 

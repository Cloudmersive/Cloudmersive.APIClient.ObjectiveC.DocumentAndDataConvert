...
**startDeletePageNumber** | **NSNumber*** | Page number (1-based) to start deleting pages; inclusive | [optional] 
**endDeletePageNumber** | **NSNumber*** | Page number (1-based) to stop deleting pages; inclusive | [optional] 
